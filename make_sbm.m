...
%parameters
%   N: network size; clust: a cell array specifying K communities; all 
%   nodes should be in exactly one community. p: within-cluster density, 
%   either a scalar (for all clusters to have same density) or a vector 
%   of length K. q: scalar outside-of-cluster density.
